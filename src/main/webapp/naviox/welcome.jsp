...
In ProgramaRepuestosDeMotos-labels_en.properties:
ProgramaRepuestosDeMotos=My application
ProgramaRepuestosDeMotos[description]=My application does this and that

In ProgramaRepuestosDeMotos-messages_en.properties:
